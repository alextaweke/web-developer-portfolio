...
const About: React.FC = () => (
  <section id="about" className="relative py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900/20 overflow-hidden">
          ...
          >
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                My name is <strong className="text-blue-600 dark:text-blue-400">Alemayehu Taweke</strong>, a passionate full-stack web developer with a strong foundation in computer science and modern web technologies.
              </p>
            </div>
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                Graduated from <strong className="text-green-600 dark:text-green-400">Ambo University</strong> with a <strong>BSc in Computer Science</strong>, achieving outstanding academic results:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                <div className="flex items-center gap-2 text-sm bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 p-3 rounded-lg">
                  ...
                  <span><strong>CGPA:</strong> 3.86/4.0</span>
                </div>
                <div className="flex items-center gap-2 text-sm bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-3 rounded-lg">
                  <span className="text-lg">🏆</span>
                  <span><strong>Exit Exam:</strong> 75/100</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                Completed advanced courses in <strong className="text-purple-600 dark:text-purple-400">Web Development</strong> and <strong className="text-purple-600 dark:text-purple-400">Artificial Intelligence</strong> from <strong>Ethio Coders</strong>.
              </p>
              <div className="flex flex-wrap gap-2 mt-4">
                {["React", "TypeScript", "NestJS", "Django", "Node.js", "PostgreSQL", "AWS"].map((tech) => (
                  <span
                    key={tech}
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                I'm a dedicated team player with excellent <strong className="text-yellow-600 dark:text-yellow-400">problem-solving skills</strong> and a strong focus on writing <strong>clean, scalable, and efficient code</strong>. I thrive in collaborative environments and continuously seek opportunities to learn and grow in software development.
              </p>
            </div>
          </motion.div>
        </div>
